/**
 * Audiobook library: every imported book, and the way to bring a new one in.
 *
...
/**
 * What a library row should call itself.
 *
 ...
 */
function libraryState(book: BookListEntry): BookState {
