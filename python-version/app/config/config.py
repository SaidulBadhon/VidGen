...
def load_config():
    # fix: IsADirectoryError: [Errno 21] Is a directory: '/VidGen/config.toml'
...
project_name = _cfg.get("project_name", "VidGen")
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/SaidulBadhon/VidGen'>https://github.com/SaidulBadhon/VidGen</a>",
)
project_version = _cfg.get("project_version", __version__)
reload_debug = False

# MPT_APP_REDIS_HOST was the pre-rebrand name; still honoured as a fallback.
app["redis_host"] = os.getenv(
    "VIDGEN_APP_REDIS_HOST",
    os.getenv(
        "MPT_APP_REDIS_HOST",
