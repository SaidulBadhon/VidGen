...
LATEST_RELEASE_API_URL: Final = (
    "https://api.github.com/repos/SaidulBadhon/VidGen/releases/latest"
)
LATEST_RELEASE_PAGE_URL: Final = (
    "https://github.com/SaidulBadhon/VidGen/releases/latest"
)
...
RELEASE_CHECK_HEADERS: Final = {
    ...
    "User-Agent": "VidGen-Version-Checker",
}
...
class AsyncUpdateChecker:
    ...
    def _run_check(self, current_version: str) -> None:
        try:
            ...
            logger.exception(
                "unexpected error while checking for a VidGen update"
            )
